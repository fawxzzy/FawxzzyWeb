...
Home is the concise discovery storefront. Apps is the single comparison and installation surface. Both use the same product identity and responsive-media contract, and every `View app` action opens the independently owned branded app origin without an intermediate detail page.
