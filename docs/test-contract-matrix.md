...
| Unified discovery | truthful app/TikTok assertions plus redirect config | Home hierarchy, lightweight Discover fallback, WCAG, overflow | `/` and `/discover` on all four UI targets |
