...
| Fitness | Current catalog origin `https://fitness.fawxzzy.com`; legacy compatibility origin `https://fawxzzy-fitness-local.vercel.app` | Launch the branded origin; preserve the legacy origin only as an owner-lane redirect and rollback entrypoint | Fitness owner proof and separate production/domain authority |
| Mazer | Current catalog origin `https://mazer.fawxzzy.com`; legacy compatibility origin `https://fawxzzy-mazer.vercel.app` | Launch the branded origin; preserve the legacy origin only as an owner-lane redirect and rollback entrypoint | Mazer owner proof and separate production/domain authority |
...
| Socials OS | Production `/discover` exposes verified Fitness and public social destinations | Maintain sanitized distribution evidence and verify public navigation after separately admitted source changes | Exact FawxzzyWeb production receipt plus Socials OS-owned readback proof |
